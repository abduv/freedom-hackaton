    ...
    <div className="min-h-screen flex flex-col items-center bg-gray-100 py-10 space-y-6">
      ...
      {currentStep === 1 && (
        <section className="w-full max-w-xl bg-white p-8 rounded-lg shadow-md text-center">
          ...
          <div {...getResumeProps()} className="flex flex-col items-center justify-center w-full h-72 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 hover:bg-gray-100 mb-4">
      ...
      {currentStep === 2 && (
        <section className="w-full max-w-xl bg-white p-8 rounded-lg shadow-md text-center">
          ...
          {files.jobDocs.length > 0 && (
            <div className="mt-4 text-left">
              <h2 className="text-lg font-semibold text-indigo-600">Загруженные вакансии:</h2>
              <ul className="list-disc pl-6 mt-2 text-sm text-gray-700">
      ...
      {currentStep === 3 && (
        <section className="w-full max-w-xl bg-white p-8 rounded-lg shadow-md text-center">
          <h1 className="text-3xl font-semibold text-indigo-600 mb-6">Результаты поиска</h1>
          <p className="text-gray-500">Отобразите кандидатов, соответствующих вакансии.</p>
